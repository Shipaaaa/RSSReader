...
public class LineListAdapter extends RecyclerView.Adapter<LineListAdapter.ViewHolder> {
        ...
        public LineListAdapter(List<String[]> dataset) {
            mDataset = dataset;
        }

        @Override
        public LineListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                     int viewType) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.line_item_lines, parent, false);
